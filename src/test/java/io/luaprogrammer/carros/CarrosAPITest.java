...
public class  CarrosAPITest {
    ...
    private ResponseEntity<List<CarroDto>> getAllCarros(String url) {
    ...
    public void testLista() {
        List<CarroDto> carros = getAllCarros("/api/v1/carros").getBody();
    ...
    public void testListaPorTipo() {
        ...
        assertEquals(10, getAllCarros("/api/v1/carros/tipo/classicos").getBody().size());
        assertEquals(10, getAllCarros("/api/v1/carros/tipo/esportivos").getBody().size());
        assertEquals(10, getAllCarros("/api/v1/carros/tipo/luxo").getBody().size());

        assertEquals(HttpStatus.NO_CONTENT, getAllCarros("/api/v1/carros/tipo/xxx").getStatusCode());
    }
